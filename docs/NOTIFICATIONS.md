...
Secretlar qo‘shilgandan keyin **Actions → Send External Notification → Run workflow** orqali test xabari jo‘natish mumkin. `GitHub Automation Digest` esa har kuni monitoring qiladi, ammo Telegram’ga faqat muhim o‘zgarish bo‘lsa yoki dushanba kungi jamlanmada qisqa status yuboradi.
